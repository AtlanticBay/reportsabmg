-- Partial Mismatch - Mailing Address
-- Match mismacth of mailing address from new org and old
...
where 
  ...
  and (
    ...
    or a.Mailing_State__C <> b.MailingState 
   --  or a.Mailing_Zip__c <> b.MailingZip
